...
The course description, learning goals, format, and outline with links to all activities can found on [Bright Space / DSL](https://www.montana.edu/d2l/). 

## How to use this repository

1. Fork this repository to create a local copy in your github account. Do this by clicking the "Fork" button in the upper right corner of the [repository home page](https://github.com/toferkey/GPHY491).

1. Clone the forked repository to your local computer

	* Open your `Terminal`.

	* Type `git clone` and the the url for your forked copy of this repository, which is `https://github.com/<your username>/GPHY491`, where <your username> is your github user id.
